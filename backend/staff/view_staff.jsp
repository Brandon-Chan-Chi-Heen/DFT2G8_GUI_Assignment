...
<%
    ...
    int pageNo = 1;//(int) Integer.parseInt((String) request.getAttribute("pageNo"));
    String col = (String) request.getAttribute("col");
    String sort = (String) request.getAttribute("sort");
    String search = (String) request.getAttribute("search");
    String col_search = (String) request.getAttribute("col_search");
%>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<%= request.getContextPath() + "/StaffController"%>" method="POST">
                            <input id="userIdInput" name="staffId" type="hidden" value="">
                ...
                <tr class="text-center">
                    <%                        // generate table header
                        ...
                        if ((String) request.getAttribute(
                                "search") != null) {
                            searchParams = String.format("&search=%s&col_search=%s", (String) request.getAttribute("search"), (String) request.getAttribute("colSearch"));
                        }
